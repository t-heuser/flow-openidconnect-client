...
class IdentityTokenTest extends TestCase
{
    ...
    public function fromJsonRejectsInvalidJsonStrings(string $json, int $expectedExceptionCode): void
    {
        ...
        $identityToken = new IdentityToken($this->sessionManagerMock);
    ...
    public function fromJsonSetsValuesCorrectly(): void
    {
        ...
        $this->assertSame('https://id.example.com', $identityToken->getValues()['iss']);
        $this->assertSame('UWAYfzzmcaNAZy_C8a8UoUxMmhT1IlcKlXG8TnWkyIM', $identityToken->getValues()['sub']);
        $this->assertSame(
