...
{
    protected OpenIdConnectClient $oidcClient;

    protected OAuthClient|MockObject $oAuthClient;

    protected VariableFrontend $discoveryCache;

    protected VariableFrontend $jwksCache;
